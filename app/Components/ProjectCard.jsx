...
export default function ProjectCard() {
  return (
    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 mx-auto max-w-6xl mt-20  ">
      {ProjectData.map((item, index) => (
        <div key={index}>
          <Link target="_blank" className="text-center text-blue-500 " href={item.Link}>
            <div className=" rounded-lg cursor-pointer hover:brightness-50 hover:transform hover:scale-95 transition-all delay-100 ">
              <div>
                <Image
                  ...
                  width={400}
                  height={200}
                  className="h-52 w-96 rounded-t-lg"
                />
